...
/*    @BeforeEach
    ...
    @DisplayName("회원가입 정상")
    void signUp() {
        Member member1 = new Member("test1", "test1", "test1", VIP);
        Member member2 = new Member("test2", "test2", "test2", VIP);
    ...
    void updateMember() {
        Member member1 = new Member("test1", "test1", "test1", VIP);
        service.signUp(member1);
        Member updateMember = new Member("test1", "update", "update", NORMAL);
